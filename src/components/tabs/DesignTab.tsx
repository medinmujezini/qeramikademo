...
export const DesignTab: React.FC<DesignTabProps> = ({
  ...
  return (
    <div className="h-full flex flex-col">
      ...
      <div className="h-11 border-b border-t px-4 flex flex-col items-center justify-center shrink-0 overflow-x-auto relative shimmer-border-top" style={{ borderColor: 'hsl(var(--primary) / 0.10)', borderTopColor: 'hsl(var(--primary) / 0.08)', background: 'linear-gradient(90deg, hsl(var(--card)), hsl(var(--card)) 40%, hsl(38 60% 68% / 0.03) 50%, hsl(var(--card)) 60%, hsl(var(--card)))' }}>
